...
namespace NvcUtils.NvcSave
{
    public static class JsonSave
    {
        ...
        public static void Save<T>(string fileName, string filePath, T value, bool encrypt = false)
        {
        ...
        public static T Load<T>(string fileName, string filePath, T keyNotFound, bool decrypt = false)
        {
